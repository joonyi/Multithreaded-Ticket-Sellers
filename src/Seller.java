...
public abstract class Seller implements Runnable {
	...
	protected void printMsg(Customer customer, Seat seat){
		...
		if (seat == null) System.out.println(time + "  " + sellerID + " - No more seats available :-( ");
		else System.out.println(time + "  " + sellerID + " - Congratulations, your seat number is: " + seat.getSeatNumber());
